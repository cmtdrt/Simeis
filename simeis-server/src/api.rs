...
// TODO (#45) Pass complex requests via POST body instead of url
// - Navigation
// - Upgrades
...
// TODO (#45) Requires POST body implementation first
// TODO (#45) Endpoints for all kinds of information
...
// TODO (#45) Document greatly the API
