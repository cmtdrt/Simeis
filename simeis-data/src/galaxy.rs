...
// TODO (#45) Use a RwLock on each of the field, and remove the one from the Game struct
pub struct Galaxy {
    objects: BTreeMap<SpaceCoord, SpaceObject>,
    discovered: Vec<GalaxySector>, // TODO (#45) Index by sector ID in a BTreeMap
}
...
impl Galaxy {
    ...
    // TODO (#45) Generate based on the galaxy
...
// TODO (#45)   Unit tests on this one
